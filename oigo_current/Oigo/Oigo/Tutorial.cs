...
namespace Oigo
{
	public class Tutorial
	{
		...
		public void tutBegin()
		{
            ...
            //MainPage.self.addWindowElements(new Label());
            //MainPage.self.addWindowTitle(new Label());
            MainPage.self.removeTutorialChildren();
            
			MainPage.self.setTutorialVisible(true);
            Label tutorialText;
            Button noTutorial, confirm, decline;
            ...
            if (Device.RuntimePlatform == Device.Android)
            {
                ...
                {
                    Text = "Welcome to OiGo!\r\nWould you like some help learning how to use this app?",
                    Margin = 20,
                    FontSize = 20,
                    VerticalTextAlignment = TextAlignment.Center,
                    HorizontalTextAlignment = TextAlignment.Center
                };
                noTutorial = new Button
                {
            ...
            MainPage.self.addWindowTitle( tutorialText );
		...
		public void tutSetPageOne(object s, EventArgs e, string x, string y, string z)
		{
            ...
            MainPage.self.reduceButtonSize();
            MainPage.self.addWindowTitle( tutorialText );
		...
		{
            MainPage.self.increaseButtonSize();
            //MainPage.self.setTutorialVisible(false);
            StackLayout tutorialLayout = new StackLayout {
                Padding = 1 ,
        ...
        public void tutSetPageThree()
        {
            ...
            HelpMe.self.addWindowTitle(tutorialText);
