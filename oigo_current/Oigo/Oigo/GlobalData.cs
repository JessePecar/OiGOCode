    ...
    public class GlobalData
    {
        ...
        public static void Init()
        {
            ...
            else
            {
                ...
                {
                    res = "Oigo.Droid.Options.csv";
                }
                else
                {
                    res = "Oigo.iOS.Options.csv";
                }
            ...
            else
            {
                ...
                if (Device.RuntimePlatform == Device.Android)
                {
                    res = "Oigo.Droid.Helpme.csv";
                }
                else
                {
                    res = "Oigo.iOS.Helpme.csv";
                }
            ...
            else
            {
                ...
                if (Device.RuntimePlatform == Device.Android)
                {
                    res = res = "Oigo.Droid.tutStart.txt";
                }
                else
                {
                    res = "Oigo.iOS.tutStart.txt";
                }
